  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/mcramireza1/Grupo7_Metodos2/blob/main/T4/Punto_3.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "5-iJVQTV7emX",
        "outputId": "fe7b7a9f-a30b-481c-f014-dad6b3a99635"
      },
      "outputs": [
        {
          "output_type": "stream",
          ...
          "text": [
            ...
            "/tmp/ipython-input-1383483737.py:45: RuntimeWarning: invalid value encountered in subtract\n",
            "  energia = trapz_periodic((1/3)*a**3 - (delta*phix)*2)\n"
          ]
        }
      ],
